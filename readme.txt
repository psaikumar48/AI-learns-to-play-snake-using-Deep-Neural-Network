...
ABOUT THE GAME : A game was developed with a window size of 40 by 30 grids(can be modified). It will have a snake of 1 grid as body and a random grid for the food.At each crash of snake,new snake will be generated random place on the window and score will displayed in the output.
